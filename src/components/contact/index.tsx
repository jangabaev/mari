        ...
        <div className="contact_left">
          ...
          <div className="contack_left_bottom">
            ...
            <div className="contack_left_bottom_buttons">
              <a href="https:\\t.me\QwinQofficial2"><button className="contact_telegram"><svg xmlns="http://www.w3.org/2000/svg" width="42" height="36" viewBox="0 0 42 36" fill="none">
