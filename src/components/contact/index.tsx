            ...
            <div className="contack_left_bottom_buttons">
              ...
              <span>
                <button className="contact_button_show" onClick={() => modalduggle()}><svg xmlns="http://www.w3.org/2000/svg" width="34" height="35" viewBox="0 0 34 35" fill="none">
                  <path d="M32.3536 19.3536C32.5488 19.1583 32.5488 18.8417 32.3536 18.6464L29.1716 15.4645C28.9763 15.2692 28.6597 15.2692 28.4645 15.4645C28.2692 15.6597 28.2692 15.9763 28.4645 16.1716L31.2929 19L28.4645 21.8284C28.2692 22.0237 28.2692 22.3403 28.4645 22.5355C28.6597 22.7308 28.9763 22.7308 29.1716 22.5355L32.3536 19.3536ZM2 19V19.5H32V19V18.5H2V19Z" fill="#3B82F6" />
                </svg> Отправить заявку</button>
              </span>
            </div>
            <p className="contact_left_mobil_p">ООО «МАРИ» ОГРН: 1215000028440, ИНН: 5047249433, М.о. г Химки, ул Кирова, дом 10, корпус 1, помещ/ком. 205/1 </p>
          </div>
