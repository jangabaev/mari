      ...
      <div className="contact_flex">
        <div className="contact_left">
          ...
          <div className="contack_left_bottom">
            <p className="contact_left_dectope_p">ООО "МАРИ" ОГРН 1215000028440, Санкт-Петербург г, Московский пр., д. 11, лит.А <strong>Юридическая информация</strong></p>
            <div className="contack_left_bottom_buttons">
              <span><button className="contact_telegram"><svg xmlns="http://www.w3.org/2000/svg" width="42" height="36" viewBox="0 0 42 36" fill="none">
              ...
              <span>
                ...
                </svg> скачать бриф</button></span>
              <span>
                <button className="contact_button_show" onClick={() => setModalContact(!modalContact)}><svg xmlns="http://www.w3.org/2000/svg" width="34" height="35" viewBox="0 0 34 35" fill="none">
