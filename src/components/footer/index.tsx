                ...
                <div className="footer-content">
                    <div className="footer-left">
                        ...
                        <div className="footer-contact">
                            <a href='tel:+79129999299'>+7 (912) 999-92-99</a>
                            <a href='mailto:jangabaevmuxtar12@gmail.com'>hello@mari.ru</a>
                        </div>
                    </div>
                    <div className='footer_items'>
                        <div className="footer-center">
                            ...
                            <p className="footer-legal">Юридическая информация</p>
                        </div>
                        <div className="footer-right">
                            <div className="footer-social">
                                <a href="https://t.me/QwinQofficial2" className="footer-social-link">
